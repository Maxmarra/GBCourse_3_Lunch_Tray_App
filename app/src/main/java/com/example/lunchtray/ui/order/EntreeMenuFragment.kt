...
class EntreeMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.action_entreeMenuFragment2_to_accompanimentMenuFragment)
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_entreeMenuFragment2_to_startOrderFragment)
    }
